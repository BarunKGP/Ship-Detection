Our implementation of the paper [Ship Detection in Polarimetric SAR Images via Variational Bayesian Inference](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=7898790)
